...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "Kite-Print-SDK/Kite-SDK/PSPrintSDK/KitePrintSDK.xcassets"
  install_resource "Kite-Print-SDK/Kite-SDK/PSPrintSDK/OLPhotoSelectionButton.xib"
  install_resource "Kite-Print-SDK/Kite-SDK/PSPrintSDK/kite_corrupt.jpg"
  install_resource "Kite-Print-SDK/Kite-SDK/PSPrintSDK/Base.lproj/OLKiteStoryboard.storyboard"
